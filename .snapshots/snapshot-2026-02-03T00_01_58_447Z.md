...
.shop-buy-slot .shop-slot-icon {
  margin-top: -4px;
}

.shop-buy-slot .shop-slot-energy {
  position: absolute;
  bottom: 6px;
  left: 50%;
...
.shop-buy-slot .shop-slot-bar-fill {
  position: absolute;
  bottom: 0;
  left: 0;
  width: 100%;
...
.shop-slot.has-item:active {
  cursor: grabbing;
}

.shop-slot .shop-slot-num {
  position: absolute;
  top: 2px;
  left: 2px;
  font-size: 10px;
...
.shop-slot .shop-slot-icon {
  margin-top: -4px;
}

.shop-slot .shop-slot-energy {
  position: absolute;
  bottom: 6px;
  left: 50%;
  transform: translateX(-50%);
...
.shop-sell-slot .shop-slot-icon {
  margin-top: -4px;
}

.shop-sell-slot .shop-slot-energy {
  position: absolute;
  bottom: 6px;
  left: 50%;
  transform: translateX(-50%);
...
.shop-sell-slot .shop-slot-bar-fill {
  position: absolute;
  bottom: 0;
  left: 0;
  width: 100%;
...
<body>
  <div id="game-container">
    ...
    <div id="shop-menu-overlay" style="display: none;">
      ...
      <div id="shop-hotbar-overlay" aria-label="Hotbar">
        <div id="shop-hotbar">
          ...
          <div class="shop-slot" data-slot="8"></div>
        </div>
        <div id="shop-credits">
          <div class="shop-credits-label">Credits</div>
          <div class="shop-credits-value">0</div>
        </div>
      </div>
