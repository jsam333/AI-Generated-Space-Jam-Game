  ...
  <div id="game-container">
    ...
    <div id="main-menu-overlay">
      ...
      <div id="main-menu">
        ...
        <button type="button" id="main-menu-start-btn">Start Mission</button>
      </div>
    </div>
    ...
    <div id="pause-menu-overlay" style="display: none;">
      <div id="pause-menu">
        ...
        <div class="pause-actions" id="pause-actions-main">
          ...
          <button type="button" id="pause-restart-btn">Restart</button>
        </div>
        <div class="pause-actions" id="pause-actions-confirm" style="display: none;">
          <span class="pause-confirm-text">Restart game? Progress will be lost.</span>
          <div class="pause-confirm-btns">
            <button type="button" id="pause-restart-confirm-btn">Yes, Restart</button>
            <button type="button" id="pause-restart-cancel-btn">Cancel</button>
          </div>
        </div>
      </div>
    </div>
